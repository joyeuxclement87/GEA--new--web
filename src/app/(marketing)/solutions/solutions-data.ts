...
export const solutionCategoryDetails: Record<string, SolutionCategory> = {
  'bathroom-sanitary': {
    ...
    heroImage: cld('heroes-solutions-bathroom-sanitary', { w: 2400 }),
    ...
    collections: [
      { name: 'Premium Vanity Collection', desc: 'Wall-hung and freestanding vanity units with integrated basin and storage.', image: cld('solutions-bathroom-sanitary-premium-vanity-collection', { w: 800 }) },
      { name: 'Freestanding Bathtub Series', desc: 'Sculptural freestanding baths in acrylic, stone resin, and cast iron.', image: cld('solutions-bathroom-sanitary-freestanding-bathtub-series', { w: 800 }) },
      { name: 'Rainfall Shower Systems', desc: 'Overhead and handheld shower systems with thermostatic controls.', image: cld('solutions-bathroom-sanitary-rainfall-shower-systems', { w: 800 }) },
    ],
    specs: [
  ...
  'tiles-flooring': {
    ...
    heroImage: cld('heroes-solutions-tiles-flooring', { w: 2400 }),
    ...
    collections: [
      { name: 'Large Format Porcelain', desc: '1200x2400mm and 1600x3200mm slabs for seamless, uninterrupted surfaces.', image: cld('solutions-tiles-flooring-large-format-porcelain', { w: 800 }) },
      { name: 'Natural Stone Selection', desc: 'Marble, travertine, limestone, and granite in raw and honed finishes.', image: cld('solutions-tiles-flooring-natural-stone-selection', { w: 800 }) },
      { name: 'Wood-Effect Ceramics', desc: 'High-fidelity timber-look tiles for durability without wood maintenance.', image: cld('solutions-tiles-flooring-wood-effect-ceramics', { w: 800 }) },
    ],
    specs: [
  ...
  electrical: {
    ...
    heroImage: cld('heroes-solutions-electrical', { w: 2400 }),
    ...
    collections: [
      { name: 'Distribution Boards & Panels', desc: 'MDB, SMDB, and final distribution boards from Schneider, Legrand, and Hager.', image: cld('solutions-electrical-distribution-boards-panels', { w: 800 }) },
      { name: 'Cable & Containment', desc: 'Power cables, data cables, cable trays, and conduit systems.', image: cld('solutions-electrical-cable-containment', { w: 800 }) },
      { name: 'Smart Lighting Controls', desc: 'DALI, KNX, and wireless lighting control systems for intelligent spaces.', image: cld('solutions-electrical-smart-lighting-controls', { w: 800 }) },
    ],
    specs: [
  ...
  plumbing: {
    ...
    heroImage: cld('heroes-solutions-plumbing', { w: 2400 }),
    ...
    collections: [
      { name: 'Pressure Pipe Systems', desc: 'Durable piping systems for potable water and pressure applications.', image: cld('solutions-plumbing-pressure-pipe-systems', { w: 800 }) },
      { name: 'Drainage & Waste', desc: 'Efficient drainage products and waste management systems.', image: cld('solutions-plumbing-drainage-waste', { w: 800 }) },
      { name: 'Valve & Control Range', desc: 'High-grade control valves and fittings for performance-critical systems.', image: cld('solutions-plumbing-valve-control-range', { w: 800 }) },
    ],
    specs: [
  ...
  hvac: {
    ...
    heroImage: cld('heroes-solutions-hvac', { w: 2400 }),
    ...
    collections: [
      { name: 'VRF & Split Systems', desc: 'Zoned air conditioning for efficient climate control.', image: cld('solutions-hvac-vrf-split-systems', { w: 800 }) },
      { name: 'Ventilation Units', desc: 'Energy-efficient ventilation and fresh air systems.', image: cld('solutions-hvac-ventilation-units', { w: 800 }) },
      { name: 'Chiller Systems', desc: 'Industrial and commercial chiller solutions for high-load projects.', image: cld('solutions-hvac-chiller-systems', { w: 800 }) },
    ],
    specs: [
  ...
  'solar-energy': {
    ...
    heroImage: cld('heroes-solutions-solar-energy', { w: 2400 }),
    ...
    collections: [
      { name: 'PV Modules', desc: 'High-efficiency solar modules for rooftop and ground-mounted systems.', image: cld('solutions-solar-energy-pv-modules', { w: 800 }) },
      { name: 'Battery Storage', desc: 'Energy storage solutions for peak load management and resilience.', image: cld('solutions-solar-energy-battery-storage', { w: 800 }) },
      { name: 'Inverters & Mounting', desc: 'Smart inverters and mounting systems for reliable solar deployment.', image: cld('solutions-solar-energy-inverters-mounting', { w: 800 }) },
    ],
    specs: [
  ...
  'fire-safety': {
    ...
    heroImage: cld('heroes-solutions-fire-safety', { w: 2400 }),
    ...
    collections: [
      { name: 'Detection & Alarm Systems', desc: 'Smoke and heat detection with panel integration.', image: cld('solutions-fire-safety-detection-alarm-systems', { w: 800 }) },
      { name: 'Suppression Systems', desc: 'Sprinkler and suppression products for compliant installations.', image: cld('solutions-fire-safety-suppression-systems', { w: 800 }) },
      { name: 'Emergency Lighting', desc: 'Reliable emergency and evacuation lighting solutions.', image: cld('solutions-fire-safety-emergency-lighting', { w: 800 }) },
    ],
    specs: [
  ...
  'security-systems': {
    ...
    heroImage: cld('heroes-solutions-security-systems', { w: 2400 }),
    ...
    collections: [
      { name: 'Access Control', desc: 'Card, biometric, and mobile-enabled access systems.', image: cld('solutions-security-systems-access-control', { w: 800 }) },
      { name: 'Surveillance Systems', desc: 'CCTV and networked monitoring products.', image: cld('solutions-security-systems-surveillance-systems', { w: 800 }) },
      { name: 'Intrusion Detection', desc: 'Alarm systems and intelligent sensors for perimeter protection.', image: cld('solutions-security-systems-intrusion-detection', { w: 800 }) },
    ],
    specs: [
  ...
  'water-pumps': {
    ...
    heroImage: cld('heroes-solutions-water-pumps', { w: 2400 }),
    ...
    collections: [
      { name: 'Submersible Pumps', desc: 'Deep-well and submersible pump systems for water supply.', image: cld('solutions-water-pumps-submersible-pumps', { w: 800 }) },
      { name: 'Booster Systems', desc: 'Pressure boosting solutions for multi-storey and high-demand buildings.', image: cld('solutions-water-pumps-booster-systems', { w: 800 }) },
      { name: 'Pump Controls', desc: 'Controls and automation for efficient pump operation.', image: cld('solutions-water-pumps-pump-controls', { w: 800 }) },
    ],
    specs: [
  ...
  'water-heaters': {
    ...
    heroImage: cld('heroes-solutions-water-heaters', { w: 2400 }),
    ...
    collections: [
      { name: 'Heat Pump Water Heaters', desc: 'High-efficiency heat pump systems for sustainable hot water generation.', image: cld('solutions-water-heaters-heat-pump-water-heaters', { w: 800 }) },
      { name: 'Solar Water Heating', desc: 'Solar solutions for energy-conscious developments.', image: cld('solutions-water-heaters-solar-water-heating', { w: 800 }) },
      { name: 'Electric & Gas Units', desc: 'Reliable standard units for rapid deployment.', image: cld('solutions-water-heaters-electric-gas-units', { w: 800 }) },
    ],
    specs: [
  ...
  'doors-windows': {
    ...
    heroImage: cld('heroes-solutions-doors-windows', { w: 2400 }),
    ...
    collections: [
      { name: 'Aluminium Systems', desc: 'Slim-profile aluminium doors and windows for modern facades.', image: cld('solutions-doors-windows-aluminium-systems', { w: 800 }) },
      { name: 'uPVC Range', desc: 'High-performance uPVC systems with added insulation.', image: cld('solutions-doors-windows-upvc-range', { w: 800 }) },
      { name: 'Timber Joinery', desc: 'Natural timber doors and windows for premium interiors.', image: cld('solutions-doors-windows-timber-joinery', { w: 800 }) },
    ],
    specs: [
  ...
  'paint-finishes': {
    ...
    heroImage: cld('heroes-solutions-paint-finishes', { w: 2400 }),
    ...
    collections: [
      { name: 'Decorative Interior Coatings', desc: 'Premium wall and ceiling coatings for refined interiors.', image: cld('solutions-paint-finishes-decorative-interior-coatings', { w: 800 }) },
      { name: 'Exterior Weatherproofing', desc: 'Durable coatings for exposed and high-traffic facades.', image: cld('solutions-paint-finishes-exterior-weatherproofing', { w: 800 }) },
      { name: 'Texture & Special Finishes', desc: 'Decorative and feature finishes for design-led spaces.', image: cld('solutions-paint-finishes-texture-special-finishes', { w: 800 }) },
    ],
    specs: [
  ...
  'hardware-tools': {
    ...
    heroImage: cld('heroes-solutions-hardware-tools', { w: 2400 }),
    ...
    collections: [
      { name: 'Fixings & Anchors', desc: 'Structural and general-purpose fixings for robust installation.', image: cld('solutions-hardware-tools-fixings-anchors', { w: 800 }) },
      { name: 'Professional Tools', desc: 'High-performance hand and power tools for site use.', image: cld('solutions-hardware-tools-professional-tools', { w: 800 }) },
      { name: 'Specialist Hardware', desc: 'Highly specific hardware for tailored assemblies and installations.', image: cld('solutions-hardware-tools-specialist-hardware', { w: 800 }) },
    ],
    specs: [
  ...
  'smart-building': {
    ...
    heroImage: cld('heroes-solutions-smart-building', { w: 2400 }),
    ...
    collections: [
      { name: 'Building Automation', desc: 'Integrated controls for lighting, climate, and energy visibility.', image: cld('solutions-smart-building-building-automation', { w: 800 }) },
      { name: 'IoT Sensors', desc: 'Occupancy, environmental, and energy monitoring devices.', image: cld('solutions-smart-building-iot-sensors', { w: 800 }) },
      { name: 'Lighting Controls', desc: 'Intelligent lighting systems for responsive spaces.', image: cld('solutions-smart-building-lighting-controls', { w: 800 }) },
    ],
    specs: [
